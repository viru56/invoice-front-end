...
export class CurrencyService {
  // private currencyAndSymbol = ["currency", "symbol"];
  // private allSearchParams = this.currencyAndSymbol.concat(["countryName"]);
  constructor() {}
  getAllISOCodes() {
  ...
  getAllInfoByISO(iso: string):Promise<any> {
    return new Promise((resolve,reject)=>{
      if (dataJSON.hasOwnProperty(iso.toUpperCase())) {
        resolve(dataJSON[iso.toUpperCase()]);
      }else{
        reject('ISO2 code wasn\'t found')
      }
    });
  }
}
